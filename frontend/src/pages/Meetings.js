...
const Appointments = () => {
  const { appointments, dispatch } = useAppointmentsContext(); // Accessing appointments state and dispatch from AppointmentsContext
    ...
    <div className="articles">
      <div className="articles-list">
        {appointments && appointments.map(appointment => (
          <MeetingsDetails appointment={appointment} key={appointment._id} />
        ))}
      </div>
    </div>
  );
